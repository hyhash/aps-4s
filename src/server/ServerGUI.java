...
public class ServerGUI extends JFrame {
    ...
    private void initUI() {
        ...
        logScroll.setBorder(BorderFactory.createTitledBorder(
                ...
                new Font("Segoe UI Emoji", Font.BOLD, 12), new Color(0, 100, 60)));

        // Client list panel
        listModel = new DefaultListModel<>();
        clientList = new JList<>(listModel);
        clientList.setFont(new Font("Segoe UI Emoji", Font.PLAIN, 13));
        ...
        countLabel.setFont(new Font("Segoe UI Emoji", Font.BOLD, 12));
        ...
        info.setFont(new Font("Segoe UI Emoji", Font.ITALIC, 11));
